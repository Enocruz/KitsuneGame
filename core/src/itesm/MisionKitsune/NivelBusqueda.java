...
public class NivelBusqueda implements Screen, InputProcessor {
    ...
    private void crearBotones(){
        ...
        botonDer.setPosicion(70+texturaDer.getWidth(),texturaDer.getHeight()/2);
        ...
        botonSaltar2.setPosicion(ANCHO-texturaSaltar.getWidth()*1.5f,texturaSaltar.getHeight()/2);
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        if (botonIzq.contiene(x, y)||botonDer.contiene(x, y)&&botonSaltar2.contiene(x,y)) {
            if (miwa.getEstadosSalto() == Miwa.EstadosSalto.EN_PISO ||miwa.getEstadosSalto() == Miwa.EstadosSalto.BAJANDO)
                miwa.setEstadoMovimiento(Miwa.Estados.QUIETO);
        }
        return true;
    }
